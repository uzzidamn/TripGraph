...
export const MOCK_ITINERARY = {
  recommended_itinerary: {
    ...
    hotel_selection_reason:
      "Selected for proximity to Ganga ghats and strong traveller reviews. Comfort tier matches group preferences.",
    advisory_items: [
      {
        title: "Night driving avoided",
        description:
          "Both legs are daytime drives (06:00–13:00 and 15:00–21:30). Arrival at Rishikesh is afternoon, return is before midnight.",
      },
      {
        title: "Weather advisory",
        description:
          "Rishikesh is in hilly terrain. Carry light rain gear for the rafting session — June can bring brief afternoon showers.",
      },
      {
        title: "Road note — NH-334",
        description:
          "Some construction patches near Roorkee may add 20–30 minutes. Leave Gurugram by 06:00 to absorb buffer.",
      },
    ],
    local_tips: [
      "Pre-book rafting with operators in Shivpuri for better rates",
      "Ganga Aarti at 18:30 sharp — arrive 15 min early for front rows",
      "Lakshman Jhula area has great cafes; try Chotiwala Restaurant for an authentic meal",
    ],
    cost_breakdown: {
      transport: 2375,
      hotel: 1050,
  ...
  timeline: [
    {
      ...
      start_time: "06:00",
      end_time: "09:00",
      title: "Drive from Gurugram",
      type: "travel",
      weather: { temp: 27, condition: "Clear", icon: "☀️" },
      traffic: { level: "low", note: "Light traffic — NH-48 clear at 6 AM" },
    },
    {
      day: 1,
      start_time: "09:00",
      end_time: "09:45",
      title: "Breakfast at Murthal Dhaba",
      type: "meal",
      cost: 250,
    },
    {
      ...
      start_time: "09:45",
      end_time: "13:00",
      title: "Continue to Rishikesh via NH-334",
      type: "travel",
      weather: { temp: 31, condition: "Partly Cloudy", icon: "⛅" },
      traffic: { level: "moderate", note: "Construction near Roorkee — allow 20 min buffer" },
    },
    {
      day: 1,
      start_time: "13:00",
      end_time: "14:15",
      title: "Lunch at Little Buddha Cafe",
      type: "meal",
      cost: 600,
    },
    {
      ...
      start_time: "14:30",
      end_time: "16:00",
      title: "Check-in & Rest at Riverside Comfort Stay",
      type: "hotel",
      cost: 1050,
    },
    {
      ...
      start_time: "16:30",
      end_time: "17:30",
      title: "Lakshman Jhula Cafe Hopping",
      type: "activity",
      cost: 500,
    },
    {
    ...
    },
    {
      ...
      start_time: "09:00",
      end_time: "12:00",
      title: "White Water Rafting (16 km)",
      type: "activity",
      cost: 1800,
    },
    {
    ...
    },
    {
      ...
      start_time: "15:00",
      end_time: "21:30",
      title: "Return Drive to Gurugram",
      type: "travel",
      weather: { temp: 34, condition: "Sunny", icon: "☀️" },
      traffic: { level: "high", note: "Weekend return traffic — peak around 6–8 PM on NH-334" },
    },
  ],
  map_points: [
    ...
    { lat: 30.1050, lng: 78.2950, label: "Ganga Aarti — Triveni Ghat", type: "activity" },
  ],
  cost_breakdown: {
    transport: 2375,
    hotel: 1050,
